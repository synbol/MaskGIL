...
if __name__ == "__main__":
    ...
    parser.add_argument("--gpt_model",    type=str,   choices=['GPT-B', 'GPT-L', 'GPT-XL', 'GPT-XXL'], default="GPT-L") # 100M 300M 700M 1.4B
    ...
    parser.add_argument("--mask-value",   type=int,   default=16384,       help="number of epoch")
